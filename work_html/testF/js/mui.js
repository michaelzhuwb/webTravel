...
function(a) {
	...
	a.prompt_textarea = function(c, d, e, f, g) {
		if (a.os.plus) {
			if ("undefined" == typeof message) return;
			"function" == typeof d ? (g = d, d = null, e = null, f = null) : "function" == typeof e ? (g = e, e = null, f = null) : "function" == typeof f && (g = f, f = null), a.plusReady(function() {
				plus.nativeUI.prompt_textarea(c, g, e, d, f)
			})
		} else {
			
			var h = b.prompt_textarea(c);
			g(h ? {
				index: 0,
				value: h
			} : {
	...
	var d = "mui-popup",
		...
		j = "mui-popup-text",
		k = "mui-popup-input",
		k1 = "mui-popup-textarea",//新添加的弹出多行输入框
		l = "mui-popup-buttons",
		m = "mui-popup-button",
		...
		r1 = function(a) {
			return '<div class="' + k1 + '"><textarea placeholder="' + (a || "") + '"></textarea></div>'
		},
		s = function(a, b, c) {
		...
		x1 = function(b, c, d, e, f, g) {
			return "undefined" != typeof b ? ("function" == typeof c ? (f = c, g = d, c = null, d = null, e = null) : "function" == typeof d ? (f = d, g = e, d = null, e = null) : "function" == typeof e && (g = f, f = e, e = null), a.os.plus && "div" !== g ? plus.nativeUI.prompt_textarea(b, f, d || "提示", c, e || ["取消", "确认"]) : u1(s(b, d || "提示", r1(c)) + t(e || ["取消", "确认"]), f)) : void 0
		},
		y = function() {
	...
	a.closePopup = y, a.closePopups = z, a.alert = v, a.confirm = w, a.prompt = x ,a.prompt_textarea = x1
}(mui, window, document), function(a, b) {
